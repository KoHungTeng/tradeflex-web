  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: 'var(--bg-base)', color: 'var(--text-primary)', padding: 8, gap: 8, overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, gap: 8, minHeight: 0 }}>
        ...
        <div className="gold-border flex-shrink-0 no-print" style={{ overflow: 'hidden', marginLeft: 1 }}>
          <div className="gold-border-inner sidebar-inner" style={{ height: '100%', overflowY: 'auto', overflowX: 'hidden', background: 'var(--bg-card3)' }}>
            <Sidebar
              page={page}
              setPage={setPage}
            ...
            <div className="gold-border" style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
              <div className="gold-border-inner" style={{ height: '100%', overflowY: 'auto' }}>
                ...
                <div className="rounded-xl p-4 mb-4 flex gap-4 flex-wrap items-end"
                  style={{ background: 'linear-gradient(160deg, var(--bg-card3) 0%, var(--bg-card4) 100%)', border: '1px solid var(--border-light)', boxShadow: 'var(--shadow-inset), var(--shadow-card)' }}>
